...
class Solution{
    public static String getSimplifiedString(String inputString){
        ...
        inputString = inputString.chars().sorted().collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append).toString();
        int count=1;
        int i;
    ...
    public static void main(String args[]){
        String inputString="aaaabbbbbbcccdddddaaaaaaa";
